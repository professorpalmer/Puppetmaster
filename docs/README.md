...
**Current release:** [v1.22.20](CHANGELOG.md#v12220) — configurable default reviewer. Unreleased: effort-level artifact index (`effort-index` / `puppetmaster_effort_index`); see [CHANGELOG.md](CHANGELOG.md) for the full line.
