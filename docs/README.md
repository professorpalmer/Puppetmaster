...
**Current release:** [v1.22.3](CHANGELOG.md#v1223) — Grok 4.6 as the Cursor workhorse for ambitious and agentic work; see [CHANGELOG.md](CHANGELOG.md) for the full line.
