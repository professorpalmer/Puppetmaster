...
- New tests covering invocation-resolution under Cursor Node, environment overrides, the fallback path, staleness-watcher trigger/hold-off/reset, env-disable, dispatcher counter, and the doctor's Cursor-Node disambiguation. Total suite at 119 tests, all passing.
